...
def lottery(sortedStudentRecord, lotteryamt):
    print()
    chosen = random.choice(sortedStudentRecord)

    print("{} has received lottery of ${}".format(chosen, lotteryamt[0]))
...
lotteryamt = (200)
lottery(sortedStudentRecord, lotteryamt)
